...
* Options
  ...
  * -prepare_only: prepare all the folders and files needed for docking. Does actually not run docking.

  * -rescore_only: option used to perform the rescoring step only. The option assumes the current directory already contains a **poses** directory.
